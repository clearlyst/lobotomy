...
public:
	...
	static Color lerp_color(Color from, Color to, float lerp)
	{
		return Color(int(BunnyHop::lerpa(float(from.r()), float(to.r()), lerp)), int(BunnyHop::lerpa(float(from.g()), float(to.g()), lerp)), int(BunnyHop::lerpa(float(from.b()), float(to.b()), lerp)), int(BunnyHop::lerpa(float(from.a()), float(to.a()), lerp)));
	}
